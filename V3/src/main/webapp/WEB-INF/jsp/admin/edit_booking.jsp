...
<body>
    <div class="header">
        <div class="header-content">
            <h1>编辑预约</h1>
            <a href="${pageContext.request.contextPath}/admin/bookings" class="back-btn">返回预约管理</a>
        </div>
    </div>
    ...
    <div class="container">
        <div class="booking-form">
            <div class="current-info">
                <h3>当前预约信息</h3>
                <p><strong>学生：</strong>${booking.realName}</p>
                ...
                <p><strong>预约时间：</strong>${booking.createTime}</p>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/admin/updateBooking" method="post">
                ...
                <div class="form-group">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/bookings" class="btn btn-secondary">取消</a>
                </div>
            </form>
        </div>
    </div>
